...
var init = function ($canvas,$input) {
...
//  if (!$(this).is('canvas')) {
//
//      $canvas = $('<canvas width="200" height="100" style="border:1px solid #000000;"></canvas>');
//  } else {
//      $canvas = $(this);
//  }
...
window.onload = function(){
	init(document.getElementById("canvas"),document.getElementById("input"));
